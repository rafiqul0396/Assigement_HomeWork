...
<img src="https://github.com/rafiqul0396/images/blob/main/scrnli_1_10_2023_7-51-10%20PM.png" width="50%" height="50%">
...
### How you Play This Game:
 ...
 - login as example:
      - register and 
         ...
         -- password
       -in cognito mode
         - use register as user2/player 2
            - save the username
            - password
       - share the username with each other:
           - finding another user use first player username
           - enter the normal username in cognito mode 
           - then play the game
